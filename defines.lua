...
NCountry = {
	...
	STRENGTHEN_GOVERNMENT_LEGITIMACY = 3,
	STRENGTHEN_GOVERNMENT_REPUBLICAN_TRADITION = 3,
	STRENGTHEN_GOVERNMENT_HORDE_UNITY = 5,
	STRENGTHEN_GOVERNMENT_DEVOTION = 3,
	STRENGTHEN_GOVERNMENT_MERITOCRACY = 3,
...
NAI = {
	...
	DIPLOMATIC_ACTION_ALLIANCE_POWERBALANCE_FACTOR = 200, --AI scoring for alliance action is increased by this if a nation blocks a powerbalance threat.
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 200, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_AI = 200, --AI willingness to send gifts to AI nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_PLAYER = 200, --AI willingness to send gifts to human nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_SUBSIDIES_POWERBALANCE_FACTOR = 200, --AI scoring to give subsidies to nations blocking/fighting power balance threat.
	DIPLOMATIC_ACTION_CRUSADE_POWERBALANCE_FACTOR = 200, --AI scoring for calling crusade on power balance threat.
	DIPLOMATIC_ACTION_EXCOMMUNICATE_POWERBALANCE_FACTOR = 200, --AI scoring for excommunicating power balance threat.
	...
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_POWERBALANCE_FACTOR = 200, --AI additional scoring for Take on Foreign Debt for targets that block powerbalance threat.
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_ANTI_RIVAL_FACTOR = 200, --AI additional scoring for Take on Foreign Debt for targets that block at least one rival.
	...
	DIPLOMATIC_ACTION_INFLUENCE_NATION_POWERBALANCE_FACTOR = 200, --AI additional scoring for Influence Nation for targets that block powerbalance threat.
	DIPLOMATIC_ACTION_INFLUENCE_NATION_ANTI_RIVAL_FACTOR = 200, --AI additional scoring for Influence Nation for targets that block at least one rival.
	...
	COLONY_BUDGET_FRACTION = 0.9, -- AI will spend a maximum of this amount of monthly ducats for colonies.
	...
	POWERFUL_ALLY_PENALTY = 25,	-- Penalty on alliance for them already having a powerful ally if much stronger
	RIVAL_ALLIANCE_PENALTY = 25, -- Penalty on alliance chance for being allied to rivals
	ENEMY_ALLIANCE_PENALTY = 50, -- Penalty on alliance chance for being allied to enemies
	...
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 0.75, -- AI desire for a province is multiplied by this if it is not adjacent at all (including vassals and other provinces being taken in peace)
	...
	PEACE_TERMS_PROVINCE_ALLY_MULT = 1, -- AI desire for giving (non-core) provinces to its allies
	...
	PEACE_TERMS_RETURN_CORES_NOT_FRIEND_MULT = 0.25, -- AI desire for returning core provinces is multiplied by this if they are not friends of the country core is being returned to
	...
	DIPLOMATIC_ACTION_SLANDER_MERCHANTS_RIVAL_FACTOR = 50, -- AI scoring for slander merchants is increased by this if they are rivals
	...
	DIPLOMATIC_ACTION_SABOTAGE_RECRUITMENT_RIVAL_FACTOR = 100, -- AI scoring for sabotage recruitment is increased by this if they are rivals
	...
	DIPLOMATIC_ACTION_SUBSIDIES_WAR_WITH_RIVAL_FACTOR = 200, -- AI scoring for giving subsidies to a country that is at war with its rival
	DIPLOMATIC_ACTION_SUBSIDIES_RELATIVE_INCOME_FACTOR = 50, -- AI scoring for giving subsidies to a country based on its relative income to the AI nation (lower income = higher scoring)
	...
	ALLIANCE_DESIRE_TOO_MANY_RELATIONS = -10,				-- AI desire/acceptance for alliance when it has or will get too many relations. Multiplies with number of relations above limit.
